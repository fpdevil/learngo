...
// Exercise22 - Practice advanced slice operations
func Exercise22() {
	fmt.Println("")
	fmt.Println("---- 16-slices/22-adv-ops-practice Exercise: Practice advanced slice operations ----")
	...
	copy(names[cap(names)-2:cap(names)], moreNames[:2])
	// extending slice
	...
	//
	// ...
	sliced := clone[1:4:4] // low=1, high=4, max=4 => cap=max-low, len=high-low
