...
import (
	...
	"github.com/fpdevil/learngo/slices/exercises/exercises3/problems/api"
)
...
// Exercise23 - Limit the backing array sharing
func Exercise23() {
	fmt.Println("")
	fmt.Println("---- 16-slices/23-limit-the-backing-array-sharing Exercise: Limit the backing array sharing ----")
