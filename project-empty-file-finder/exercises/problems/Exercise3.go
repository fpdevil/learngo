...
// Exercise3 - Find and write the names of subdirectories to a file
func Exercise3(vals string) {
	fmt.Println("")
	fmt.Println("---- 3-print-directories EXERCISE: Find and write the names of subdirectories to a file ----")
	...
	err := ioutil.WriteFile("dirs.txt", names, 0644)
	if err != nil {
		fmt.Println(err)
		return
	}
